...
export default function PropertyDisputeKadapaPage() {
  ...
  const schema = [
    ...
    getFaqSchema([
      ...
      {
        question: "Do you help with title verification and encumbrance checks?",
        answer:
          "Yes. Title documents, encumbrance certificates, and revenue records are reviewed to assess ownership and risks before filing.",
      },
      {
        question: "Do you assist with mutation and revenue record corrections?",
        answer:
          "Yes. Revenue record corrections and related civil relief are handled with supporting documents and proper filings.",
      },
    ]),
    getBreadcrumbSchema([
      { name: "Home", href: "/" },
      ...
      <section className="section alt">
        <div className="container">
          ...
          <div className="cards">
            ...
            <div className="faq-item">
              <h3>Do you help with title verification and encumbrance checks?</h3>
              <p className="prose">
                Yes. Title documents, encumbrance certificates, and revenue
                records are reviewed to assess ownership and risks before
                filing.
              </p>
            </div>
            <div className="faq-item">
              <h3>Do you assist with mutation and revenue record corrections?</h3>
              <p className="prose">
                Yes. Revenue record corrections and related civil relief are
                handled with supporting documents and proper filings.
              </p>
            </div>
          </div>
        </div>
