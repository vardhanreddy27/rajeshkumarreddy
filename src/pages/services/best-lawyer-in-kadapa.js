...
export default function BestLawyerKadapaPage() {
  ...
  const schema = [
    ...
    getFaqSchema([
      ...
      {
        question: "Do you take cases from outside Kadapa town?",
        answer:
          "Yes. Clients from Proddatur, Badvel, Pulivendula, Rajampet, Sidhout, and nearby towns are represented.",
      },
      {
        question: "Do you represent matters in the High Court of Andhra Pradesh?",
        answer:
          "Yes. High Court appearances for appeals, revisions, and writ petitions are handled when required.",
      },
    ]),
    getBreadcrumbSchema([
      { name: "Home", href: "/" },
        ...
        <div className="container hero-grid">
          ...
          <div className="hero-card">
            <Image
              ...
              alt="Senior advocate office near Kadapa District Court"
              width={1200}
              height={720}
      ...
      <section className="section alt">
        <div className="container">
          ...
          <div className="cards">
            ...
            <div className="faq-item">
              <h3>Do you take cases from outside Kadapa town?</h3>
              <p className="prose">
                Yes. Clients from Proddatur, Badvel, Pulivendula, Rajampet,
                Sidhout, and nearby towns are represented.
              </p>
            </div>
            <div className="faq-item">
              <h3>Do you represent matters in the High Court of Andhra Pradesh?</h3>
              <p className="prose">
                Yes. High Court appearances for appeals, revisions, and writ
                petitions are handled when required.
              </p>
            </div>
          </div>
        </div>
