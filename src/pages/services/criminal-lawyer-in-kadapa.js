...
export default function CriminalLawyerKadapaPage() {
  ...
  const schema = [
    ...
    getFaqSchema([
      ...
      {
        question: "Do you assist with anticipatory bail in Kadapa?",
        answer:
          "Yes. Anticipatory bail applications are prepared with affidavits, supporting records, and a clear timeline of events.",
      },
      {
        question: "Do you represent in sessions trials and criminal appeals?",
        answer:
          "Yes. Sessions trial defense and criminal appeals are handled with evidence planning, cross examination, and written arguments.",
      },
    ]),
    getBreadcrumbSchema([
      { name: "Home", href: "/" },
      ...
      <section className="section alt">
        <div className="container">
          ...
          <div className="cards">
            ...
            <div className="faq-item">
              <h3>Do you assist with anticipatory bail in Kadapa?</h3>
              <p className="prose">
                Yes. Anticipatory bail applications are prepared with
                affidavits, supporting records, and a clear timeline of events.
              </p>
            </div>
            <div className="faq-item">
              <h3>Do you represent in sessions trials and criminal appeals?</h3>
              <p className="prose">
                Yes. Sessions trial defense and criminal appeals are handled
                with evidence planning, cross examination, and written
                arguments.
              </p>
            </div>
          </div>
