...
export default function ChequeBounceKadapaPage() {
  ...
  const schema = [
    ...
    getFaqSchema([
      ...
      {
        question: "What happens if payment is not made after the notice?",
        answer:
          "A complaint can be filed within statutory timelines, and evidence is prepared with the cheque, memo, and notice records.",
      },
      {
        question: "Do you represent in trial and appeal for cheque bounce cases?",
        answer:
          "Yes. The office handles trial evidence, witness preparation, and appeals when required.",
      },
    ]),
    getBreadcrumbSchema([
      { name: "Home", href: "/" },
      ...
      <section className="section alt">
        <div className="container">
          ...
          <div className="cards">
            ...
            <div className="faq-item">
              <h3>What happens if payment is not made after the notice?</h3>
              <p className="prose">
                A complaint can be filed within statutory timelines, and
                evidence is prepared with the cheque, memo, and notice records.
              </p>
            </div>
            <div className="faq-item">
              <h3>Do you represent in trial and appeal for cheque bounce cases?</h3>
              <p className="prose">
                Yes. The office handles trial evidence, witness preparation,
                and appeals when required.
              </p>
            </div>
          </div>
        </div>
