...
export default function CivilLawyerKadapaPage() {
  ...
  const schema = [
    ...
    getFaqSchema([
      ...
      {
        question: "Do you handle civil appeals and execution proceedings?",
        answer:
          "Yes. Civil appeals, revisions, and execution petitions are handled with certified copies, proper grounds, and follow up for enforcement.",
      },
      {
        question: "Can I seek interim injunctions early in a civil matter?",
        answer:
          "Yes. Interim relief can be requested when urgency and documents are shown clearly; timelines depend on court listing and evidence.",
      },
    ]),
    getBreadcrumbSchema([
      { name: "Home", href: "/" },
      ...
      <section className="section alt">
        <div className="container">
          ...
          <div className="cards">
            ...
            <div className="faq-item">
              <h3>Do you handle civil appeals and execution proceedings?</h3>
              <p className="prose">
                Yes. Civil appeals, revisions, and execution petitions are
                handled with certified copies, proper grounds, and follow up
                for enforcement.
              </p>
            </div>
            <div className="faq-item">
              <h3>Can I seek interim injunctions early in a civil matter?</h3>
              <p className="prose">
                Yes. Interim relief can be requested when urgency and documents
                are shown clearly; timelines depend on court listing and
                evidence.
              </p>
            </div>
          </div>
