...
export const PRACTICE_PAGES = [
  createPage({
    ...
    faqs: [
      ...
      {
        question: "Is a legal notice required before filing a civil suit in Kadapa?",
        answer:
          "Not always, but issuing a notice is often advisable to document the dispute and may lead to settlement before filing.",
      },
      {
        question: "Do you assist with settlement or mediation in civil disputes?",
        answer:
          "Yes. Negotiation or mediation is considered when appropriate, alongside full trial preparation when needed.",
      },
    ],
  }),
  createPage({
...
export const getDefaultFaqs = (page) => [
  ...
  {
    question: `Is a legal notice required before filing a ${page.service} case?`,
    answer:
      "It depends on the dispute. A legal notice is often advisable to document issues and may resolve the matter before filing.",
  },
  {
    question: `Can ${page.service} matters be resolved through settlement or mediation?`,
    answer:
      "Yes. Settlement or mediation is considered when appropriate, alongside a court strategy if hearings are required.",
  },
];
